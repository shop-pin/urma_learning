...
static int run_test(test_dlock_ctx_t *ctx)
{
    ...
    for (int i = 0; i < TEST_NUM; i++) {
        ...
        lock_req.lock_op = (i % 2) ? LOCK_EXCLUSIVE : LOCK_SHARED;
        ...
        lock_req.lock_id = lock_id;
        lock_req.lock_op = (i % 2) ? EXTEND_LOCK_EXCLUSIVE : EXTEND_LOCK_SHARED;
